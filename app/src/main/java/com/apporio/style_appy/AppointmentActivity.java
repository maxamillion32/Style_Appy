...
import com.apporio.style_appy.Setter_Getter.Stafflistbydate_Outter;
...
public class AppointmentActivity extends Activity implements DatePickerDialog.OnDateSetListener {
    LinearLayout back;
...
//    String data[] = {"Location 1", "Location 2", "Location 3", "Location 4"};
    ...
    public static AppointmentActivity apc;
    ...
    private List<Inner_Staffservicebystaff> Staffnames = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        Statusbar.setStatusBarColor(AppointmentActivity.this, R.color.statusbarcolor);
        ...
        parsingloc(AppointmentActivity.this, productid);
        name.setText("" + productname);
        descp.setText(""+productdescp);
        rates.setText("£ " + productrate);
        duration.setText("Duration - "+productduration);
        prefs2 = PreferenceManager.getDefaultSharedPreferences(AppointmentActivity.this);
...
//                }
//                showlocationdialog3(data3, texttime);
                if (textdate.getText().toString().trim().equals("")) {
                    Toast.makeText(AppointmentActivity.this, "Please select date first !!!", Toast.LENGTH_SHORT).show();
                } else {
                    parsingtime(AppointmentActivity.this, productid, locationidvalue, datevalue);
                }
            }
        });
        ...
        llfrstaff.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (textloc.getText().toString().trim().equals("")) {
                    Toast.makeText(AppointmentActivity.this, "Please select location first !!!", Toast.LENGTH_SHORT).show();
                } else {
                    parsingstaffbydatetime(AppointmentActivity.this, productid, locationidvalue);
                }
            }
        });
        llforreview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(textloc.getText().toString().trim().equals("")||
                    ...
                    Toast.makeText(AppointmentActivity.this, "Please fill required fields !!!", Toast.LENGTH_SHORT).show();
                }
                else {
                    Intent in = new Intent(AppointmentActivity.this, ReviewActivity.class);
                    in.putExtra("fragment", "service");
                    in.putExtra("activity", "appoint");
...
//                dpd.setMaxDate(cal);
        ...
        addnote.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(AppointmentActivity.this, NoteActivity.class);
                in.putExtra("activity","appoint");
                startActivity(in);
    ...
    private void showlocationdialog(ArrayList<String> data, final TextView textloc, ArrayList<String> location_id) {
        ...
        final Dialog dialog = new Dialog(AppointmentActivity.this, android.R.style.Theme_Translucent_NoTitleBar);
    ...
    private View addviewradiobutton(int layout_name, String s1, int i, boolean checkedss2, final ArrayList<String> locationid) {
        ...
        LayoutInflater layoutInflater =
                (LayoutInflater) AppointmentActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
...
//                pd.dismiss();
                AppointmentActivity.pb.setVisibility(View.GONE);
                try {
                    ...
                    if (received2.status.equals("1")) {
                        ...
                        Toast.makeText(AppointmentActivity.this, "No location found !!!", Toast.LENGTH_SHORT).show();
        ...
        queue.add(sr);
//        pd.show();
        AppointmentActivity.pb.setVisibility(View.VISIBLE);
    ...
    public  void parsingtime(final Context c, String serviceid, String locationid,String datevalue) {
        ...
        queue = VolleySingleton.getInstance(c).getRequestQueue();
        //   Toast.makeText(getActivity(),"id"+CategoryId,Toast.LENGTH_SHORT).show();
        String urlforRest_food = Apis_url.Timeslotservicebydate+serviceid+"/"+locationid+"/"+datevalue;
        urlforRest_food = urlforRest_food.replace(" ", "%20");
        Log.e("bahjd", "" + urlforRest_food);
        sr = new StringRequest(Request.Method.POST, urlforRest_food, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Accountinfoshow_Outter received23 = new Accountinfoshow_Outter();
                    received23 = gson.fromJson(response, Accountinfoshow_Outter.class);

                    if (received23.status.equals("1")) {
                    ...
                    if (received2.status.equals("1")) {
                        ...
                        Toast.makeText(AppointmentActivity.this, "No time slots found !!!", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public  void parsingstaffbydatetime(final Context c, String serviceid, String locationid) {

        prefs2 = PreferenceManager.getDefaultSharedPreferences(c);
        queue = VolleySingleton.getInstance(c).getRequestQueue();
        //   Toast.makeText(getActivity(),"id"+CategoryId,Toast.LENGTH_SHORT).show();
        String urlforRest_food = Apis_url.Staffservicebydate+serviceid+"/"+locationid+"/"+
                datevalue+"/"+timeidvalue;
        urlforRest_food = urlforRest_food.replace(" ", "%20");
        Log.e("bahjd", "" + urlforRest_food);
        sr = new StringRequest(Request.Method.POST, urlforRest_food, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (received2.status.equals("1")) {
                        Stafflistbydate_Outter received22 = new Stafflistbydate_Outter();
                        received22 = gson.fromJson(response, Stafflistbydate_Outter.class);


                            Staffnames = received22.data_staff;
                        ...
                        Toast.makeText(AppointmentActivity.this, "No staff members found !!!", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                    Log.e("err", "" + e);
